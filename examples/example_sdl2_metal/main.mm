// Dear Gui: standalone example application for SDL2 + Metal
...
int main(int, char **) {
  ...
  SDL_Window *window =
      SDL_CreateWindow("Dear Gui SDL+Metal example", SDL_WINDOWPOS_CENTERED,
  ...
  Metal_Init(layer.device);
  SDL2_InitForMetal(window);
