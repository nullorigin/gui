...
// enums/functions that we use in our opengl3.cpp source file in
// order to be small.
//
// YOU SHOULD NOT NEED TO INCLUDE/USE THIS DIRECTLY. THIS IS USED BY
// opengl3.cpp ONLY. THE REST OF YOUR APP SHOULD USE A DIFFERENT GL
...
// 'opengl3.cpp' OR INCUDING 'opengl3_loader.hpp' IN THE
...
// UNIT. BUT IF YOU REALLY WANT TO, you can '#define OPENGL_LOADER_CUSTOM'
// and opengl3.cpp WILL NOT BE USING OUR LOADER, AND INSTEAD EXPECT
// ANOTHER/YOUR LOADER TO BE AVAILABLE IN THE COMPILATION UNIT.
//
// Regenerate with:
//   python gl3w_gen.py --output ../imgui/backends/opengl3_loader.hpp
//   --ref ../imgui/backends/opengl3.cpp ./extra_symbols.txt
//
// More info:
