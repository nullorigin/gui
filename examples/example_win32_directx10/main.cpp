// Dear Gui: standalone example application for DirectX 10
...
int main(int, char **) {
  ...
  WNDCLASSEXW wc = {sizeof(wc),
                    ...
                    nullptr};
  ::RegisterClassExW(&wc);
  HWND hwnd = ::CreateWindowW(wc.lpszClassName, L"Dear Gui DirectX10 Example",
  ...
  while (!done) {
    ...
    DX10_RenderDrawData(Gui::GetDrawData());
