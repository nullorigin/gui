...
used to determine when timeouts have occured. The time base should be a cyclic
millisecond time value.

@returns			Time value in milliseconds
**/
typedef unsigned int (*uSynergyGetTimeFunc)();
...
typedef struct {
  ...
  uSynergyBool m_isCaptured; /* Is Synergy active (i.e. this client is receiving
                                input messages?) */
  unsigned int m_lastMessageTime; /* Time at which last message was received */
  unsigned int m_sequenceNumber;  /* Packet sequence number */
